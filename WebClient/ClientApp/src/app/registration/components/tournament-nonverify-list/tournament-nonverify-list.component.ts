...
@Component({
  selector: 'app-tournament-nonverify-list',
  templateUrl: './tournament-nonverify-list.component.html',
  styleUrls: []
})
export class TournamentNonverifyListComponent {
  ...
  source: any =
    {
      ...
      id: 'id',
      url: APP_CONFIG.appServiceEndpoint + 'api/Tournament/GetTournamentNonVerifiedListData?userId=' + SMECache.GetCache(StringConstants.CurrentUserId)
    };
